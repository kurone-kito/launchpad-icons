...
(() => {
  ...
  searchInput.addEventListener("input", ({ target: { value = "" } }) => {
    const items = packageGrid.querySelectorAll(
  ...
  const addListingToVccHelpClose = document.getElementById(
    "addListingToVccHelpClose"
  );
  addListingToVccHelpClose.addEventListener("click", () => {
    addListingToVccHelp.hidden = true;
  });

  const vccListingInfoUrlFieldCopy = document.getElementById(
  ...
  vccAddRepoButton.addEventListener("click", () =>
    window.location.assign(
      `vcc://vpm/addRepo?url=${encodeURIComponent(LISTING_URL)}`
    )
  );
  ...
  const packageInfoModalClose = document.getElementById(
    "packageInfoModalClose"
  );
  ...
  const packageInfoDescription = document.getElementById(
    "packageInfoDescription"
  );
  const packageInfoAuthor = document.getElementById("packageInfoAuthor");
  const packageInfoDependencies = document.getElementById(
  ...
  const rowPackageInfoButton = document.querySelectorAll(
  ...
  rowPackageInfoButton.forEach((button) => {
    button.addEventListener("click", (e) => {
      ...
      if (!packageInfo) {
        console.error(
          `Did not find package ${packageId}. Packages available:`,
          PACKAGES
        );
        return;
      }
  ...
  const packageInfoVccUrlFieldCopy = document.getElementById(
  ...
  const packageInfoListingHelp = document.getElementById(
