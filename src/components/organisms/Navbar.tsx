    ...
    >
      <div class="flex w-full flex-wrap items-center justify-between px-3 lg:gap-6">
        ...
        >
          ...
          >
            <Show when={addToVccLink} keyed>
              {(url) => (
                <NavMenuItem class="font-bold hidden lg:block" url={url}>
                  Add to VCC
                </NavMenuItem>
              )}
            </Show>
            <NavMenuItem url="docs">Documents</NavMenuItem>
            <NavMenuItem url="explore">Icons</NavMenuItem>
            <NavMenuItem url="pricing">Pricing</NavMenuItem>
          </ul>
