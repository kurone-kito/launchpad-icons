...
import { Booth } from '../atoms/Booth.js';
...
export const Navbar: Component = () => {
  ...
  return (
    <header class="navbar bg-base-200 px-safe pt-safe flex-col items-stretch drop-shadow-xl md:flex-row">
      ...
      <nav
        class={clsx(
          'flex grow-0 flex-col items-stretch md:flex md:grow md:flex-row md:justify-between',
          { hidden: !expanded() },
        )}
      >
        <ul class="menu md:menu-horizontal items-stretch pb-1 pt-4">
          <li>
