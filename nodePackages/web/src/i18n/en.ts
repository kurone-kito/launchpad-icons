...
const en: Resources = {
  ...
  description:
    'The VRC Icons are a collection of VRChat-like icons. All icons are provided in SVG vector format.',
  docs: 'Docs',
  explore: 'Explore',
  exploreDescription:
  ...
  features4Body: 'MIT License.',
  features4Heading: 'Free & OSS!',
  gettingStarted: 'Getting Started',
  gettingStartedTitle: 'Getting Started',
  language: '🇬🇧',
  plan: 'plan',
  planFree1: 'Unrestricted use under MIT license',
  planFree2: 'Community based support',
  planBasic1: 'All features from the Free plan',
  planBasic2: 'Willingness to make more use of the VRC Icons',
